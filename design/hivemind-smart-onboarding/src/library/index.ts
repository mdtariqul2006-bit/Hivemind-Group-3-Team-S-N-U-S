...
export const HIVEMIND_RESEARCH = {
  brand: {
    ...
    tagline: 'AI-powered onboarding and knowledge systems. Tailored to your organisation.',
  ...
  valuePropositions: [
    ...
    },
    {
      ...
      body: 'Our platform uses AI to surface the right documentation, guidance and next steps at the right time. An AI work buddy that answers context-specific questions or analytics that show where people struggle.',
      image: ASSETS.usp2,
    },
    {
      id: 'usp-3',
